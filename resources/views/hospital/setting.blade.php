                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label>Address:</label>
                                {!! Form::textarea('address', null, ['class' => 'form-control', 'size' => '7x3']) !!}
                            </div>
                            <div class="form-group">
                                <label>Contact:</label>
                                {!! Form::textarea('contact', null, ['class' => 'form-control', 'size' => '7x3']) !!}
                            </div>
                            <div class="form-group">
                                <label>About Us:</label>
                                {!! Form::textarea('description', null, ['class' => 'form-control', 'size' => '5x8']) !!}
                            </div>
                            <div class="form-group">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('tax_type', null, ['class' => 'form-control']) !!}
                            </div>
                            <div class="form-group">
                                <label>Percent (%)</label>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('patient_prefix', null, ['class' => 'form-control']) !!}
                            </div>
                            <div class="form-group">
                                <label>Invoice Message:</label>
                                {!! Form::text('invoice_message', null, ['class' => 'form-control']) !!}
                            </div>
                            <div class="form-group">
                                <button class="btn btn-success" type="submit">Save Changes</button>
                                <button class="btn btn-primary" type="reset">Default</button>
