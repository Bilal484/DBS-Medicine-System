        ...
        <div class="row">
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">Package Table<a class="btn btn-sm btn-primary pull-right"
                            href="{{ url('/') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($package->packageTests()->get() as $package_test)
                                                    <li>{{ $package_test->test->name }}<a class="btn-sm" id="test_delete"
                                                            data-id="{{ $package_test->id }}"><span
                                                                class="glyphicon glyphicon-remove"></span></a></li>
                                                @endforeach
                                            </td>
                                            <td>Rs{{ $package->price }}</td>
                                            <td>
                                                <button id="package_edit" class="btn-sm btn-info"
                                                    data-edit="{{ $package->id }}, {{ $package->name }}, {{ $package->description }}, {{ $package->price }}, {{ $package->status }}"><span
                                                        class="glyphicon glyphicon-edit"></span>
                                                </button>

                                                <button class="btn-sm btn-danger" data-package="{{ $package->id }}"
                                                    id="package_delete"><span
                ...
                <div class="panel panel-default">
                        ...
                        <div class="form-group">
                            ...
                            <select name="test_id[]" class="form-control select" required style="width:100%" multiple="">
                                ...
                                @foreach ($tests as $test)
                                    <option value="{{ $test->id }}" data-name="{{ $test->name }}">
                                        {{ $test->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="panel-footer">
                        <button class="btn btn-success" type="submit"><span
                                class='glyphicon glyphicon-edit'></span>Add</button>
            ...
            <div class="col-md-4 edit" style="display: none">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['route' => 'package.edit', 'method' => 'POST']) !!}
        ...
        <div class="modal fade" id="delete" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    {!! Form::open(['route' => 'package.test.delete', 'method' => 'POST']) !!}
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger" type="submit"><span class='glyphicon glyphicon-ok'></span>
                            Yes</button>
                    </div>
                    {{ Form::close() }}
                </div>
        ...
        <div class="modal fade" id="deletePackage" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    {!! Form::open(['route' => 'package.delete', 'method' => 'POST']) !!}
                    <div class="modal-body">
