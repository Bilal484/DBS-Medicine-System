...
<div id="print">
    <div class="row">
        ...
        <div class="col-md-6">
            <strong>Patient: </strong>{{ $invoice_return->invoice->patient->first_name }}
            {{ $invoice_return->invoice->patient->last_name }}<br>
...
<br>
<div align="center">
    <a href="{{ url('invoice/report') }}" class="btn btn-primary" type='button' id='printbtn'
        onclick="Function()"><span class="glyphicon glyphicon-print"></span> Print</a>
</div>
