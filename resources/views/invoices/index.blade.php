        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span>Service
                        Bill</div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-8">
                                <!-- services -->
                                <div class="row">
                                    {{ Form::open(['route' => 'invoice.store', 'method' => 'post', 'class' => 'form-group']) }}
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select class="form-control select" name="patient_id" id="patient_id" required>
                                            ...
                                            @foreach ($patients as $patient)
                                                <option value="{{ $patient->id }}">ID: {{ $patient->id }}.
                                    ...
                                    <div id="payment" style="display: none;">
                                        ...
                                        <div class="col-md-2 form-group">
                                            <label>Cash :</label>
                                            <input type="number" name="cash" placeholder="" class="form-control"
                                                id="cash" required><br>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" id="calculateBtn" style="display: none">
                                        <button class="btn btn-primary" id="calculate"><span
                                                class="glyphicon glyphicon-ok"></span>Calculate</button> <br><br><span
                                            id="msg"></span><br>
                ...
                if (sub_total.length) {
                    ...
                    if (cash > 0) {
                        ...
                        if (tender_amount < 0) {
                            ...
                            $('#msg').show();
                            $("#msg").html(
                                "<div style='color:red;margin-bottom: 20px;'><span class='btn-sm alert-danger'>Insufficient Balance...</span></div>"
                                );
                        } else {
                            ...
                            $('#complete').show();
                            $('#comment').show();
                            $('#tender').html('<strong>Sub Total: $' + sub_total +
                                '</strong><br><strong>Discount:$' + discount +
                                '</strong><br><b>------------------------------</b><br><strong>Taxable Amount:' +
                                total.toFixed(2) + '</strong><br><strong>HST(' + tax + '%): $' +
                                tax_amount.toFixed(2) +
                                '</strong><br><b>-----------------------------<b><br><strong>Total: $' +
                                total_amount.toFixed() + '</strong><br><strong>Cash: $ ' + cash +
                                '</strong><br><strong>Return:$' + tender_amount.toFixed() + '</strong>');
                            $('#tender').show();
                        }
                    } else {
                        $('#msg').show();
                        $("#msg").html(
                            "<div style='color:red;margin-bottom: 20px;'><span class='btn-sm alert-danger'>Enter Cash Amount...</span></div>"
                            );
                    }
                } else {
                    $('#msg').show();
                    $("#msg").html(
                        "<div style='color:red;margin-bottom: 20px;'><span class='btn-sm alert-danger'>Please Select Doctor First...</span></div>"
                        );
