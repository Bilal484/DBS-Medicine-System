                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    {{ Form::open(['route' => 'opd.store', 'method' => 'post', 'class' => 'form-group']) }}
                        ...
                        if (cash > 0) {
                            ...
                            if (tender_amount < 0) {
                                ...
                                $('#tender').html('<strong>Sub Total: $' + sub_total +
                                    ...
                                    total + '</strong><br><strong>HST(' + tax + '%): $' + tax_amount +
                                    '</strong><br><b>-----------------------------<b><br><strong>Total: $' +
                                    total_amount + '</strong><br><strong>Cash: $ ' + cash +
                                    '</strong><br><strong>Return:$' + tender_amount + '</strong>');
                                $('#tender').show();
                            }
                        } else {
                            $('#msg').show();
