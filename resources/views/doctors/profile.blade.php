                ...
                <div class="panel panel-default">
                    <div class="panel-heading">{{ $doctor->employee->first_name }} {{ $doctor->employee->last_name }}
                        <a style="margin-left: 8px" class="btn btn-sm btn-primary pull-right" data-toggle="modal"
                            href="#editDoctor"><span class="glyphicon glyphicon-edit"></span> Edit Doctor</a><a
                            class="btn btn-sm btn-default pull-right" href="{{ url('doctor') }}">Back <span
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <label>Available Time: {{ $doctor->employee->in_time }} -
                                {{ $doctor->employee->out_time }}</label><br>
                            ...
                            <table data-toggle="table" data-show-refresh="true" data-show-toggle="true"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($doctor->opd_sales()->get() as $sales)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $sales->invoice->patient->first_name }}
                                                {{ $sales->invoice->patient->middle_name }}
                                                {{ $sales->invoice->patient->last_name }}</td>
                                            <td>{{ $doctor->fee }}</td>
                                            <td>Complete</td>
                                        </tr>
                                    @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" type="submit"><span class='glyphicon glyphicon-remove'></span>
                        Yes</button>
                </div>
                {{ Form::close() }}
            </div>
