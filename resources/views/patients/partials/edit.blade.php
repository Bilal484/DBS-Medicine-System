            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class=" col-md-4 form-group">
                        ...
                        {!! Form::text('birth_date', null, ['class' => 'form-control', 'id' => 'nepaliDate5']) !!}
                    </div>
                    <div class=" col-md-4 form-group">
                        <label>Age:</label>
                    ...
                    <div class=" col-md-4 form-group">
                        ...
                        {!! Form::input('number', 'relative_phone', null, ['class' => 'form-control']) !!}
                    </div>
                    <div class=" col-md-4 form-group">
                        <label>Country:</label>
                    ...
                    <div class=" col-md-4 form-group">
                        ...
                        {!! Form::textarea('location', null, ['class' => 'form-control', 'required' => 'required', 'size' => '5x3']) !!}
                    </div>

                    <div class=" col-md-4 form-group">
                        <label>Occupation:</label>
                        {!! Form::textarea('occupation', null, ['class' => 'form-control', 'size' => '5x3']) !!}
                    </div>
                    <div class=" col-md-4 form-group">
                        <label>Descrption:</label>
                        {!! Form::textarea('description', null, ['class' => 'form-control', 'size' => '5x3']) !!}
                    </div>
